...
<h1 class="d-none">Bienvenido a Yuntas</h1>
    ...
    <div class="info ">
      <div class="container home-info">
        <div class="imagen-info col-lg-6">
          <div class="imgTexto">
            <h2>ÚNICO Y </h2> 
            <img class="img_info" src="<?=URL?>public/img/imagen-info.webp" alt="imagen-info">
          </div>
         <h2 class="rotar">DIFERENTE</h2>
        </div>
        <div class="col-lg-5 padretexto">
          <div class="texto-info">
          <h3>BRINDAMOS UNA EXPERIENCIA ÚNICA Y DIFERENTE CON NUESTROS PRODUCTOS IDEALES PARA TU CUARTO O EMPRESA.</h3>
          <h3>¿QUÉ ESPERAS?</h3>
          </div>
