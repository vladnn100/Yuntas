...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="public/css/efectos3d.css">
    ...
    <title>Efectos 3D</title>
    <style>
    .contenedor_Principal{
     font-family: 'Bungee', cursive;

        height : 75vh;
        background-image: url("public/efectos3d/banner.webp");
  ...
  <body>
    ...
    <div class="cortina d-flex align-items-end">
        <div class="texto_principal p-3 p-md-5 text-white">
            <h1 class="title fw-bold">EFECTOS 3D</h1>
            
            <div class="whatsapp what_principal my-4 d-flex justify-content-around">
                <a href="https://wa.me/51912849782?text=Hola,%20estoy%20interesado%20en%20los%20Efectos%203D" class="fs-3 nav-link border text-white bg-info a-w rounded-full d-flex justify-content-center align-items-center "><i class="fa-brands fa-whatsapp d-block"></i></a>
