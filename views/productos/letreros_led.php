  ...
  <head>
    ...
    .contenedor_Principal{
     font-family: 'Bungee', cursive;
        ...
        height : 75vh;
        background-image: url("public/letreros_led/imagen_fondo.jpeg");
  ...
  <body>
    ...
    <div class="cortina d-flex align-items-end">
        <div class="texto_principal p-3 p-md-5 text-white">
            <h1 class="title fw-bold">LETREROS LED</h1>
            
            <div class="whatsapp what_principal my-4 d-flex justify-content-around">
                <a href="https://wa.me/51912849782?text=Hola,%20estoy%20interesado%20en%20los%20Letreros%20Led" class="fs-3 nav-link border text-white bg-info a-w rounded-full d-flex justify-content-center align-items-center "><i class="fa-brands fa-whatsapp d-block"></i></a>
	...
	<div class="row py-4 px-5 mx-auto d-block container-fluid">
            ...
            <img class="img_abajo" src="public\letreros_led\imagen_segundo.jpeg" alt="">
	...
	<div class=" row py-4 px-5 mx-auto d-block container-fluid">
            ...
            <img class="img_abajo" src="public\letreros_led\imagen_tercero.jpeg" alt="">
